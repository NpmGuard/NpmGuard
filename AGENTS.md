...
Read `README.md` first. Scope changes to one subproject. Each has its own `AGENTS.md` with gotchas:

- [`cli/AGENTS.md`](cli/AGENTS.md) — package manager detection, ESM, WalletConnect flow, SSE streaming
- [`engine/AGENTS.md`](engine/AGENTS.md) — payment verification, chain config, report-store versioning
