...
#  - Every packet the -Y filter admitted must yield an event. Looking the fields up
#    under hardcoded layer names drops roughly half of a real capture, silently and
#    indistinguishably from no traffic, because mdns, llmnr and ssdp carry them too.
#    The filter and the extraction share one list.
