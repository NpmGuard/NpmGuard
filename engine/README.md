...
| `NPMGUARD_FREE_MAX_PUBLIC_REPO_AUDITS` | `2` | Distinct public GitHub repositories included with Free; re-auditing the same GitHub repository does not consume another slot |
