 ...
 * travels on a stamp that carries a glyph and a word — `ProgressStamp` on the
 * achromatic progress axis, `VerdictStamp` for a concluded outcome. A blue
 * running dot is doubly wrong: a hue on the progress axis, and against danger-red
 * it is the pair §2.3's colourblind check fails on.
 *
